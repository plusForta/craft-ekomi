...
namespace plusforta\ekomi;

use plusforta\ekomi\services\Data as DataService;
use plusforta\ekomi\variables\EkomiVariable;
use plusforta\ekomi\models\Settings;
...
class Ekomi extends Plugin
{
    ...
    public function init()
    {
        ...
        if (Craft::$app instanceof ConsoleApplication) {
            $this->controllerNamespace = 'plusforta\ekomi\console\controllers';
        }
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('ekomi', EkomiVariable::class);
            }
        );
